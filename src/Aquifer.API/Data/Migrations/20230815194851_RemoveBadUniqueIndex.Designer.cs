...
namespace Aquifer.API.Data.Migrations
{
    ...
    [Migration("20230815194851_RemoveBadUniqueIndex")]
    partial class RemoveBadUniqueIndex
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Aquifer.API.Data.Entities.ResourceEntity", b =>
                {
                    ...
                    b.HasIndex("Type", "MediaType", "EnglishLabel")
                        .IsUnique();
            ...
            modelBuilder.Entity("Aquifer.API.Data.Entities.PassageEntity", b =>
                {
                    b.HasOne("Aquifer.API.Data.Entities.VerseEntity", "EndVerse")
                        .WithMany()
                        .HasForeignKey("EndVerseId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Aquifer.API.Data.Entities.VerseEntity", "StartVerse")
                        .WithMany()
