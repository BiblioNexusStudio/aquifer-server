...
public enum TranslationOrigin
{
    ...
    /// status after translation/aquiferization. After all Resource Contents have been translated then all will be assigned to the Project's Company Lead.
    /// </summary>
    Project,
    ...
    /// translation/aquiferization. Will also translate resource contents that aren't in the <see cref="ResourceContentStatus.TranslationAwaitingAiDraft"/>
    ...
    /// not transition to <see cref="ResourceContentStatus.TranslationAiDraftComplete"/> or <see cref="ResourceContentStatus.AquiferizeAiDraftComplete"/>).
    /// </summary>
