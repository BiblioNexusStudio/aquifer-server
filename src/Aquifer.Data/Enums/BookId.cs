...
public enum BookId
{
    ...
    [Display(Name = "Esther Greek")]
    BookESG = 70,

    [Display(Name = "Wisdom of Solomon")]
    BookWIS = 71,
    ...
    [Display(Name = "Letter of Jeremiah")]
    BookLJE = 74,

    [Display(Name = "Song of the 3 Young Men")]
    BookS3Y = 75,

    [Display(Name = "Susanna")]
    BookSUS = 76,

    [Display(Name = "Bel and the Dragon")]
    BookBEL = 77,

    [Display(Name = "1 Maccabees")]
    Book1MA = 78,

    [Display(Name = "2 Maccabees")]
    Book2MA = 79,

    [Display(Name = "3 Maccabees")]
    Book3MA = 80,

    [Display(Name = "4 Maccabees")]
    Book4MA = 81,

    [Display(Name = "1 Esdras (Greek)")]
    Book1ES = 82,

    [Display(Name = "2 Esdras (Latin)")]
    Book2ES = 83,

    [Display(Name = "Prayer of Manasseh")]
    BookMAN = 84,

    [Display(Name = "Psalm 151")]
    BookPS2 = 85,

    [Display(Name = "Odae/Odes")]
    BookODA = 86,
