...
#pragma warning restore IDE0010
        ...
        if (completedContentIds.Count > 0)
        {
            await dbContext.Projects
                .Where(x => x.ProjectResourceContents.Any(prc => completedContentIds.Contains(prc.ResourceContent.Id)) &&
                ...
                .ExecuteUpdateAsync(x => x.SetProperty(p => p.ActualPublishDate, DateOnly.FromDateTime(DateTime.UtcNow))
        ...
        {
            await dbContext.Projects
                .Where(x => x.ProjectResourceContents.Any(prc => inReviewContentIds.Contains(prc.ResourceContent.Id)) &&
                    x.ProjectResourceContents
                ...
                .ExecuteUpdateAsync(x => x.SetProperty(p => p.ActualDeliveryDate, DateOnly.FromDateTime(DateTime.UtcNow))
                    .SetProperty(p => p.Updated, DateTime.UtcNow));
        }
        ...
        {
            await dbContext.Projects
                .Where(x => x.ActualDeliveryDate != null &&
                ...
                .ExecuteUpdateAsync(x =>
                    x.SetProperty(p => p.ActualDeliveryDate, null as DateOnly?).SetProperty(p => p.Updated, DateTime.UtcNow));
        }
    }
}