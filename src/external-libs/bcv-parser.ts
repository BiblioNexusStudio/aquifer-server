// copied from https://github.com/openbibleinfo/Bible-Passage-Reference-Parser
// @ts-nocheck
(function () {
    let bcv_parser,
        bcv_passage,
    ...
    bcv_parser = (function () {
        ...
        bcv_parser.prototype.parse_with_context = function (s, context) {
            let entities, ref, ref1, ref2;
            this.reset();
            (ref = this.match_books(this.replace_control_characters(context))),
                (context = ref[0]),
                (this.passage.books = ref[1]);
        ...
        bcv_parser.prototype.set_options = function (options) {
            ...
            for (key in options) {
                ...
                val = options[key];
                if (
                    key === 'include_apocrypha' ||
                    key === 'versification_system' ||
                    key === 'case_sensitive'
                ) {
                    this[key](val);
                } else {
        ...
        bcv_parser.prototype.include_apocrypha = function (arg) {
            let base, base1, ref, translation, verse_count;
            ...
            for (translation in ref) {
                ...
                if ((base1 = this.translations[translation].chapters)['Ps'] == null) {
                    base1['Ps'] = bcv_utils.shallow_clone_array(
        ...
        bcv_parser.prototype.versification_system = function (system) {
            let base, base1, base2, book, chapter_list, ref, ref1;
            ...
            if (this.translations.alternates['default'] != null) {
                if (system === 'default') {
                    if (this.translations.alternates['default'].order != null) {
                        this.translations['default'].order = bcv_utils.shallow_clone(
                    ...
                    for (book in ref) {
                        ...
                        this.translations['default'].chapters[book] =
                            bcv_utils.shallow_clone_array(chapter_list);
                    }
                } else {
            ...
            if (system !== 'default' && this.translations[system].order != null) {
                ...
                this.translations['default'].order = bcv_utils.shallow_clone(
                    this.translations[system].order,
                );
            }
            if (system !== 'default' && this.translations[system].chapters != null) {
                ...
                for (book in ref1) {
                    ...
                    if ((base2 = this.translations.alternates['default'].chapters)[book] == null) {
                        base2[book] = bcv_utils.shallow_clone_array(
                            this.translations['default'].chapters[book],
                        );
                    }
                    this.translations['default'].chapters[book] =
        ...
        bcv_parser.prototype.translation_info = function (new_translation) {
            let book, chapter_list, id, old_translation, out, ref, ref1, ref2;
            if (new_translation == null) {
                new_translation = 'default';
            }
            if (
                new_translation != null &&
                ((ref = this.translations.aliases[new_translation]) != null ? ref.alias : void 0) !=
                    null
            ) {
        ...
        bcv_parser.prototype.match_books = function (s) {
            let book, books, has_replacement, k, len, ref;
            books = [];
        ...
        bcv_parser.prototype.match_passages = function (s) {
            ...
            while ((match = this.regexps.escaped_passage.exec(s))) {
                ...
                start_index_adjust =
                    part.substr(0, 1) === '\x1f' ? 0 : part.split('\x1f')[0].length;
                passage = {
                ...
                if (
                    this.options.book_alone_strategy === 'full' &&
                    this.options.book_range_strategy === 'include' &&
                    passage.value[0].type === 'b' &&
                    (passage.value.length === 1 ||
                        (passage.value.length > 1 &&
                            passage.value[1].type === 'translation_sequence')) &&
                    start_index_adjust === 0 &&
                    (this.passage.books[book_id].parsed.length === 1 ||
                        (this.passage.books[book_id].parsed.length > 1 &&
                ...
                regexp_index_adjust = this.adjust_regexp_end(
                    accum,
                    original_part_length,
                    part.length,
                );
        ...
        bcv_parser.prototype.create_book_range = function (s, passage, book_id) {
            let cases, i, k, limit, prev, range_regexp, ref;
            cases = [
                bcv_parser.prototype.regexps.first,
                bcv_parser.prototype.regexps.second,
                bcv_parser.prototype.regexps.third,
            ];
        ...
        bcv_parser.prototype.add_book_range_object = function (passage, prev, start_book_number) {
            let i, k, length, ref, ref1, results;
            ...
            results = [];
            for (
                i = k = 1, ref = passage.value.length;
                1 <= ref ? k < ref : k > ref;
                i = 1 <= ref ? ++k : --k
            ) {
        ...
        bcv_parser.prototype.parsed_entities = function () {
            ...
            out = [];
            for (
                entity_id = k = 0, ref = this.entities.length;
                0 <= ref ? k < ref : k > ref;
                entity_id = 0 <= ref ? ++k : --k
            ) {
                ...
                if (entity.passages[0].translations != null) {
                    ...
                    for (l = 0, len = ref1.length; l < len; l++) {
                        translation = ref1[l];
                        translation_osis =
                            ((ref2 = translation.osis) != null ? ref2.length : void 0) > 0
                                ? translation.osis
                                : '';
                ...
                for (
                    ...
                    if (passage.valid.valid === false) {
                        if (
                            this.options.invalid_sequence_strategy === 'ignore' &&
                    ...
                    osises.push({
                        osis: passage.valid.valid
                            ? this.to_osis(passage.start, passage.end, translation_alias)
                            : '',
                        type: passage.type,
                ...
                if (
                    osises.length > 1 &&
                    this.options.consecutive_combination_strategy === 'combine'
                ) {
                ...
                if (this.options.sequence_combination_strategy === 'separate') {
                    ...
                    if (
                        osises[last_i].enclosed_indices != null &&
                        osises[last_i].enclosed_indices[1] >= 0
                    ) {
        ...
        bcv_parser.prototype.to_osis = function (start, end, translation) {
            ...
            if (end.c == null) {
                if (
                    ...
                    (this.passage.translations[translation].chapters[end.b] != null &&
                        this.passage.translations[translation].chapters[end.b].length === 1)
                ) {
            ...
            if (end.v == null) {
                if (
                    this.passage.translations[translation].chapters[end.b][end.c - 1] != null &&
            ...
            if (
                ...
                ((end.c === 999 && end.v === 999) ||
                    (end.c === this.passage.translations[translation].chapters[end.b].length &&
                        ...
                        (end.v === 999 ||
                            (end.v ===
                                this.passage.translations[translation].chapters[end.b][end.c - 1] &&
                                this.options.passage_existence_strategy.indexOf('v') >= 0))))
            ) {
                osis.start = start.b;
                osis.end = end.b;
        ...
        bcv_parser.prototype.fix_ps151 = function (start, end, translation) {
            ...
            if (
                translation !== 'default' &&
                ((ref = this.translations[translation]) != null ? ref.chapters['Ps151'] : void 0) ==
                    null
            ) {
            ...
            for (
                ...
                if (osis.osis.length > 0) {
                    ...
                    if (
                        ...
                        (i === last_i ||
                            osises[i + 1].enclosed_indices[0] !== osis.enclosed_indices[0])
                    ) {
        ...
        bcv_parser.prototype.is_verse_consecutive = function (prev, check, translation) {
            let translation_order;
            if (prev.b == null) {
                return false;
            }
            translation_order =
                this.passage.translations[translation].order != null
                    ? this.passage.translations[translation].order
            ...
            if (prev.b === check.b) {
                if (prev.c === check.c) {
                    ...
                    if (
                        prev.v ===
                        this.passage.translations[translation].chapters[prev.b][prev.c - 1]
                    ) {
                        return true;
                    }
                }
                ...
                if (
                    prev.c === this.passage.translations[translation].chapters[prev.b].length &&
                    prev.v === this.passage.translations[translation].chapters[prev.b][prev.c - 1]
                ) {
                    return true;
                }
            }
        ...
        bcv_parser.prototype.snap_range = function (entity, passage_i) {
            let entity_i, key, pluck, ref, source_entity, target_entity, temp, type;
            if (
            ...
            for (key in ref) {
                if (!hasProp.call(ref, key)) continue;
                entity.passages[passage_i][target_entity][key] =
                    entity.passages[passage_i][source_entity][key];
            }
        ...
        bcv_parser.prototype.starts_with_book = function (passage) {
            ...
            if (
                (passage.type === 'range' || passage.type === 'ff') &&
                passage.start.type.substr(0, 1) === 'b'
            ) {
                return true;
            }
            return false;
        ...
        bcv_parser.prototype.remove_absolute_indices = function (passages, i) {
            let end, k, len, passage, ref, ref1, start;
            ...
            for (k = 0, len = ref1.length; k < len; k++) {
                passage = ref1[k];
                if (
                    passage.enclosed_absolute_indices[0] === start &&
                    passage.enclosed_absolute_indices[1] === end
                ) {
    ...
    bcv_passage = (function () {
        ...
        bcv_passage.prototype.handle_array = function (passages, accum, context) {
            ...
            for (k = 0, len = passages.length; k < len; k++) {
                ...
                (ref = this.handle_obj(passage, accum, context)),
                    (accum = ref[0]),
                    (context = ref[1]);
            }
        ...
        bcv_passage.prototype.b = function (passage, accum, context) {
            let alternates, b, k, len, obj, ref, valid;
        ...
        bcv_passage.prototype.b_range_pre = function (passage, accum, context) {
            let book, end, ref, ref1, start_obj;
            passage.start_context = bcv_utils.shallow_clone(context);
            passage.passages = [];
            book = this.pluck('b', passage.value);
            (ref = this.b(book, [], context)),
                ((ref1 = ref[0]), (end = ref1[0])),
                (context = ref[1]);
            if (passage.absolute_indices == null) {
                passage.absolute_indices = this.get_absolute_indices(passage.indices);
            }
        ...
        bcv_passage.prototype.bc = function (passage, accum, context) {
            let alternates, b, c, context_key, k, len, obj, ref, ref1, valid;
            passage.start_context = bcv_utils.shallow_clone(context);
            passage.passages = [];
            ...
            for (k = 0, len = ref.length; k < len; k++) {
                ...
                (ref1 = this.fix_start_zeroes(obj.valid, obj.start.c, obj.start.v)),
                    (obj.start.c = ref1[0]),
                    (obj.start.v = ref1[1]);
                if (obj.start.v == null) {
                    delete obj.start.v;
        ...
        bcv_passage.prototype.bc_title = function (passage, accum, context) {
            let bc, i, k, ref, ref1, ref2, title;
            passage.start_context = bcv_utils.shallow_clone(context);
            (ref = this.bc(this.pluck('bc', passage.value), [], context)),
                ((ref1 = ref[0]), (bc = ref1[0])),
                (context = ref[1]);
            if (bc.passages[0].start.b.substr(0, 2) !== 'Ps' && bc.passages[0].alternates != null) {
                for (
                    i = k = 0, ref2 = bc.passages[0].alternates.length;
        ...
        bcv_passage.prototype.bcv = function (passage, accum, context) {
            let alternates, b, bc, c, k, len, obj, ref, ref1, v, valid;
            passage.start_context = bcv_utils.shallow_clone(context);
            passage.passages = [];
            this.reset_context(context, ['b', 'c', 'v']);
        ...
        bcv_passage.prototype.bv = function (passage, accum, context) {
            ...
            (ref1 = this.bcv(bcv, [], context)),
                ((ref2 = ref1[0]), (bcv = ref2[0])),
                (context = ref1[1]);
        ...
        bcv_passage.prototype.c = function (passage, accum, context) {
            ...
            c =
                passage.type === 'integer'
                    ? passage.value
                    : this.pluck('integer', passage.value).value;
            valid = this.validate_ref(passage.start_context.translations, {
                b: context.b,
                c: c,
            });
        ...
        bcv_passage.prototype.ff = function (passage, accum, context) {
            ...
            (ref = this.range(passage, [], passage.start_context)),
                ((ref1 = ref[0]), (passage = ref1[0])),
                (context = ref[1]);
        ...
        bcv_passage.prototype.next_v = function (passage, accum, context) {
            let prev_integer, psg, ref, ref1, ref2, ref3;
            passage.start_context = bcv_utils.shallow_clone(context);
            ...
            (ref = this.range(passage, [], passage.start_context)),
                ((ref1 = ref[0]), (psg = ref1[0])),
                (context = ref[1]);
            if (
                psg.passages[0].valid.messages.end_verse_not_exist != null &&
                psg.passages[0].valid.messages.start_verse_not_exist == null &&
                psg.passages[0].valid.messages.start_chapter_not_exist == null &&
                context.c != null
            ) {
                passage.value.pop();
                passage.value.push({
                ...
                (ref2 = this.range(passage, [], passage.start_context)),
                    ((ref3 = ref2[0]), (psg = ref3[0])),
                    (context = ref2[1]);
            }
        ...
        bcv_passage.prototype.sequence = function (passage, accum, context) {
            let k, l, len, len1, obj, psg, ref, ref1, ref2, ref3, sub_psg;
            passage.start_context = bcv_utils.shallow_clone(context);
            passage.passages = [];
            ref = passage.value;
            for (k = 0, len = ref.length; k < len; k++) {
                obj = ref[k];
                (ref1 = this.handle_array(obj, [], context)),
                    ((ref2 = ref1[0]), (psg = ref2[0])),
                    (context = ref1[1]);
                ref3 = psg.passages;
                for (l = 0, len1 = ref3.length; l < len1; l++) {
                    ...
                    sub_psg.enclosed_absolute_indices =
                        psg.type === 'sequence_post_enclosed' ? psg.absolute_indices : [-1, -1];
        ...
        bcv_passage.prototype.range = function (passage, accum, context) {
            ...
            (ref1 = this.handle_obj(start, [], context)),
                ((ref2 = ref1[0]), (start = ref2[0])),
                (context = ref1[1]);
            if (
                end.type === 'v' &&
                ((start.type === 'bc' &&
                    !((ref3 = start.passages) != null
                        ? (ref4 = ref3[0]) != null
                            ? (ref5 = ref4.valid) != null
                                ? (ref6 = ref5.messages) != null
                                    ? ref6.start_chapter_not_exist_in_single_chapter_book
                                    : void 0
                                : void 0
                            : void 0
                        : void 0)) ||
            ...
            (ref7 = this.handle_obj(end, [], context)),
                ((ref8 = ref7[0]), (end = ref8[0])),
                (context = ref7[1]);
            ...
            if (valid.valid) {
                ...
                return this.range_handle_invalid(
                    valid,
                    passage,
                    start,
                    start_obj,
        ...
        bcv_passage.prototype.range_check_new_end = function (
            translations,
            start_obj,
            end_obj,
            valid,
        ) {
            let new_end, new_valid, obj_to_validate, type;
            new_end = 0;
            type = null;
        ...
        bcv_passage.prototype.range_handle_invalid = function (
            valid,
            passage,
            start,
            start_obj,
            ...
            let new_end, ref, temp_valid, temp_value;
            if (
                (valid.valid === false &&
                ...
                new_end = this.range_check_new_end(
                    passage.start_context.translations,
                    start_obj,
                    end_obj,
                    valid,
                );
            ...
            (ref = [
                ...
                (passage.original_value = ref[0]),
                (passage.value = ref[1]);
            return this.sequence(passage, accum, passage.start_context);
        };

        bcv_passage.prototype.range_handle_valid = function (
            valid,
            passage,
            start,
            start_obj,
        ...
        bcv_passage.prototype.range_validate = function (valid, start_obj, end_obj, passage) {
            ...
            (ref = this.fix_start_zeroes(valid, start_obj.c, start_obj.v)),
                (start_obj.c = ref[0]),
                (start_obj.v = ref[1]);
            return true;
        };
        ...
        bcv_passage.prototype.translation_sequence = function (passage, accum, context) {
            let k, l, len, len1, ref, translation, translations, val;
            passage.start_context = bcv_utils.shallow_clone(context);
            translations = [];
            translations.push({
            ...
            for (l = 0, len1 = translations.length; l < len1; l++) {
                ...
                if (this.translations.aliases[translation.translation] != null) {
                    ...
                    translation.osis =
                        this.translations.aliases[translation.translation].osis ||
        ...
        bcv_passage.prototype.translation_sequence_apply = function (accum, translations) {
            let context, i, k, new_accum, ref, ref1, use_i;
            use_i = 0;
            for (
                i = k = ref = accum.length - 1;
                ref <= 0 ? k <= 0 : k >= 0;
                i = ref <= 0 ? ++k : --k
            ) {
            ...
            if (use_i < accum.length) {
                ...
                (ref1 = this.handle_array(accum.slice(use_i), [], accum[use_i].start_context)),
                    (new_accum = ref1[0]),
                    (context = ref1[1]);
            } else {
        ...
        bcv_passage.prototype.fix_start_zeroes = function (valid, c, v) {
            if (
                valid.messages.start_chapter_is_zero &&
                this.options.zero_chapter_strategy === 'upgrade'
            ) {
                c = valid.messages.start_chapter_is_zero;
            }
            if (
                valid.messages.start_verse_is_zero &&
                this.options.zero_verse_strategy === 'upgrade'
            ) {
        ...
        bcv_passage.prototype.calculate_indices = function (match, adjust) {
            ...
            for (m = 0, len2 = parts.length; m < len2; m++) {
                ...
                if (switch_type === 'book') {
                    ...
                    adjust =
                        this.books[part].start_index + this.books[part].value.length - match_index;
                    indices.push({
                        start: end_index + 1,
                        end: end_index + 1,
                        index: adjust,
        ...
        bcv_passage.prototype.get_absolute_indices = function (arg1) {
            let end, end_out, index, k, len, ref, start, start_out;
        ...
        bcv_passage.prototype.validate_ref = function (translations, start, end) {
            let k, len, messages, temp_valid, translation, valid;
            ...
            for (k = 0, len = translations.length; k < len; k++) {
                ...
                if (end) {
                    temp_valid = this.validate_end_ref(
                        translation.alias,
                        start,
                        end,
                        temp_valid,
        ...
        bcv_passage.prototype.validate_start_ref = function (translation, start, messages) {
            let ref, ref1, translation_order, valid;
            valid = true;
            if (
                translation !== 'default' &&
                ((ref = this.translations[translation]) != null ? ref.chapters[start.b] : void 0) ==
                    null
            ) {
                this.promote_book_to_translation(start.b, translation);
            }
            translation_order =
                ((ref1 = this.translations[translation]) != null ? ref1.order : void 0) != null
                    ? translation
                    : 'default';
            if (start.v != null) {
            ...
            if (this.translations[translation_order].order[start.b] != null) {
                ...
                if (
                    start.c > 0 &&
                    this.translations[translation].chapters[start.b][start.c - 1] != null
                ) {
                    if (start.v != null) {
                        if (isNaN(start.v)) {
                            valid = false;
                            ...
                            start.v > this.translations[translation].chapters[start.b][start.c - 1]
                        ) {
                            if (this.options.passage_existence_strategy.indexOf('v') >= 0) {
                                valid = false;
                                messages.start_verse_not_exist =
                                    this.translations[translation].chapters[start.b][start.c - 1];
                            }
                        }
                    } else if (
                        start.c === 1 &&
                        this.options.single_chapter_1_strategy === 'verse' &&
                        this.translations[translation].chapters[start.b].length === 1
                    ) {
                    ...
                    if (
                        ...
                        valid = false;
                        messages.start_chapter_not_exist =
                            this.translations[translation].chapters[start.b].length;
                    }
                }
        ...
        bcv_passage.prototype.validate_end_ref = function (
            translation,
            start,
            end,
            valid,
            ...
            let ref, translation_order;
            translation_order =
                ((ref = this.translations[translation]) != null ? ref.order : void 0) != null
                    ? translation
                    : 'default';
            if (end.c != null) {
            ...
            if (this.translations[translation_order].order[end.b] != null) {
                ...
                if (
                    this.translations[translation_order].order[start.b] != null &&
                    this.translations[translation_order].order[start.b] >
                        this.translations[translation_order].order[end.b]
                ) {
                    if (this.options.passage_existence_strategy.indexOf('b') >= 0) {
                        valid = false;
                    }
                ...
                if (end.c != null && !isNaN(end.c)) {
                    if (this.translations[translation].chapters[end.b][end.c - 1] == null) {
                        if (this.translations[translation].chapters[end.b].length === 1) {
                            ...
                            messages.end_chapter_not_exist =
                                this.translations[translation].chapters[end.b].length;
                        }
                    }
                }
                if (end.v != null && !isNaN(end.v)) {
                    ...
                    if (
                        end.v > this.translations[translation].chapters[end.b][end.c - 1] &&
                        this.options.passage_existence_strategy.indexOf('v') >= 0
                    ) {
                        messages.end_verse_not_exist =
                            this.translations[translation].chapters[end.b][end.c - 1];
                    }
                }
            } else {
                valid = false;
        ...
        bcv_passage.prototype.promote_book_to_translation = function (book, translation) {
            ...
            if (this.translations[translation].chapters[book] == null) {
                return (this.translations[translation].chapters[book] =
                    bcv_utils.shallow_clone_array(this.translations['default'].chapters[book]));
            }
        };
    ...
    bcv_parser.prototype.regexps.translations =
    ...
    bcv_parser.prototype.translations = {
        ...
        default: {
            ...
            chapters: {
                ...
                Ps: [
                    ...
                    10, 22, 12, 14, 9, 11, 12, 24, 11, 22, 22, 28, 12, 40, 22, 13, 17, 13, 11, 5,
                    26, 17, 11, 9, 14, 20, 23, 19, 9, 6, 7, 23, 13, 11, 11, 17, 12, 8, 12, 11, 10,
                    13, 20, 7, 35, 36, 5, 24, 20, 28, 23, 10, 12, 20, 72, 13, 19, 16, 8, 18, 12, 13,
                    17, 7, 18, 52, 17, 16, 15, 5, 23, 11, 13, 12, 9, 9, 5, 8, 28, 22, 35, 45, 48,
                    43, 13, 31, 7, 10, 10, 9, 8, 18, 19, 2, 29, 176, 7, 8, 9, 4, 8, 5, 6, 5, 6, 8,
                    8, 3, 18, 3, 3, 21, 26, 9, 8, 24, 13, 10, 7, 12, 15, 21, 10, 20, 14, 9, 6,
                ],
                Prov: [
                ...
                Isa: [
                    31, 22, 26, 6, 30, 13, 25, 22, 21, 34, 16, 6, 22, 32, 9, 14, 14, 7, 25, 6, 17,
                    25, 18, 23, 12, 21, 13, 29, 24, 33, 9, 20, 24, 17, 10, 22, 38, 22, 8, 31, 29,
                    25, 28, 28, 25, 13, 15, 22, 26, 11, 23, 15, 12, 17, 13, 12, 21, 14, 21, 22, 11,
                    12, 19, 12, 25, 24,
                ],
                Jer: [
                ...
                Sir: [
                    30, 18, 31, 31, 15, 37, 36, 19, 18, 31, 34, 18, 26, 27, 20, 30, 32, 33, 30, 31,
                    28, 27, 27, 34, 26, 29, 30, 26, 28, 25, 31, 24, 33, 31, 26, 31, 31, 34, 35, 30,
        ...
        vulgate: {
            chapters: {
                ...
                Exod: [
                    22, 25, 22, 31, 23, 30, 25, 32, 35, 29, 10, 51, 22, 31, 27, 36, 16, 27, 25, 26,
                    36, 31, 33, 18, 40, 37, 21, 43, 46, 38, 18, 35, 23, 35, 35, 38, 29, 31, 43, 36,
                ],
                Lev: [
                    17, 16, 17, 35, 19, 30, 38, 36, 24, 20, 47, 8, 59, 57, 33, 34, 16, 30, 37, 27,
                ...
                Num: [
                    54, 34, 51, 49, 31, 27, 89, 26, 23, 36, 34, 15, 34, 45, 41, 50, 13, 32, 22, 30,
                    35, 41, 30, 25, 18, 65, 23, 31, 39, 17, 54, 42, 56, 29, 34, 13,
                ],
                Josh: [
                    18, 24, 17, 25, 16, 27, 26, 35, 27, 44, 23, 24, 33, 15, 63, 10, 18, 28, 51, 9,
                    43, 34, 16, 33,
                ],
                Judg: [
                    36, 23, 31, 24, 32, 40, 25, 35, 57, 18, 40, 15, 25, 20, 20, 31, 13, 31, 30, 48,
                    24,
                ],
                '1Sam': [
                    28, 36, 21, 22, 12, 21, 17, 22, 27, 27, 15, 25, 23, 52, 35, 23, 58, 30, 24, 43,
                ...
                '1Chr': [
                    54, 55, 24, 43, 26, 81, 40, 40, 44, 14, 46, 40, 14, 17, 29, 43, 27, 17, 19, 7,
                    30, 19, 32, 31, 31, 32, 34, 21, 30,
                ],
                Neh: [11, 20, 31, 23, 19, 19, 73, 18, 38, 39, 36, 46, 31],
                Job: [
                    22, 13, 26, 21, 27, 30, 21, 22, 35, 22, 20, 25, 28, 22, 35, 23, 16, 21, 29, 29,
                    34, 30, 17, 25, 6, 14, 23, 28, 25, 31, 40, 22, 33, 37, 16, 33, 24, 41, 35, 28,
                    25, 16,
                ],
                Ps: [
                    6, 13, 9, 10, 13, 11, 18, 10, 39, 8, 9, 6, 7, 5, 10, 15, 51, 15, 10, 14, 32, 6,
                    10, 22, 12, 14, 9, 11, 13, 25, 11, 22, 23, 28, 13, 40, 23, 14, 18, 14, 12, 5,
                    26, 18, 12, 10, 15, 21, 23, 21, 11, 7, 9, 24, 13, 12, 12, 18, 14, 9, 13, 12, 11,
                    14, 20, 8, 36, 37, 6, 24, 20, 28, 23, 11, 13, 21, 72, 13, 20, 17, 8, 19, 13, 14,
                    17, 7, 19, 53, 17, 16, 16, 5, 23, 11, 13, 12, 9, 9, 5, 8, 29, 22, 35, 45, 48,
                    43, 14, 31, 7, 10, 10, 9, 26, 9, 10, 2, 29, 176, 7, 8, 9, 4, 8, 5, 6, 5, 6, 8,
                    8, 3, 18, 3, 3, 21, 26, 9, 8, 24, 14, 10, 8, 12, 15, 21, 10, 11, 9, 14, 9, 6,
                ],
                Eccl: [18, 26, 22, 17, 19, 11, 30, 17, 18, 20, 10, 14],
                Song: [16, 17, 11, 16, 17, 12, 13, 14],
                Jer: [
                    19, 37, 25, 31, 31, 30, 34, 22, 26, 25, 23, 17, 27, 22, 21, 21, 27, 23, 15, 18,
                    14, 30, 40, 10, 38, 24, 22, 17, 32, 24, 40, 44, 26, 22, 19, 32, 20, 28, 18, 16,
                    18, 22, 13, 30, 5, 28, 7, 47, 39, 46, 64, 34,
                ],
                Ezek: [
                    28, 9, 27, 17, 17, 14, 27, 18, 11, 22, 25, 28, 23, 23, 8, 63, 24, 32, 14, 49,
                    32, 31, 49, 27, 17, 21, 36, 26, 21, 26, 18, 32, 33, 31, 15, 38, 28, 23, 29, 49,
                    26, 20, 27, 31, 25, 24, 23, 35,
                ],
                ...
                Hag: [14, 24],
                Matt: [
                    25, 23, 17, 25, 48, 34, 29, 34, 38, 42, 30, 50, 58, 36, 39, 28, 26, 35, 30, 34,
                    46, 46, 39, 51, 46, 75, 66, 20,
                ],
                Mark: [45, 28, 35, 40, 43, 56, 37, 39, 49, 52, 33, 44, 37, 72, 47, 20],
                John: [
                    51, 25, 36, 54, 47, 72, 53, 59, 41, 42, 57, 50, 38, 31, 27, 33, 26, 40, 42, 31,
                    25,
                ],
                Acts: [
                    26, 47, 26, 37, 42, 15, 59, 40, 43, 48, 30, 25, 52, 27, 41, 40, 34, 28, 40, 38,
                    40, 30, 35, 27, 27, 32, 44, 31,
                ],
                '2Cor': [24, 17, 18, 18, 21, 18, 16, 24, 15, 18, 33, 21, 13],
                Rev: [
                    20, 29, 22, 11, 14, 17, 17, 13, 21, 11, 19, 18, 18, 20, 8, 21, 18, 24, 21, 15,
                    27, 21,
                ],
                ...
                Sir: [
                    40, 23, 34, 36, 18, 37, 40, 22, 25, 34, 36, 19, 32, 27, 22, 31, 31, 33, 28, 33,
                    31, 33, 38, 47, 36, 28, 33, 30, 35, 27, 42, 28, 33, 31, 26, 28, 34, 39, 41, 32,
                    28, 26, 37, 27, 31, 23, 31, 28, 19, 31, 38, 13,
                ],
        ...
        nab: {
            ...
            chapters: {
                ...
                Exod: [
                    22, 25, 22, 31, 23, 30, 29, 28, 35, 29, 10, 51, 22, 31, 27, 36, 16, 27, 25, 26,
                    37, 30, 33, 18, 40, 37, 21, 43, 46, 38, 18, 35, 23, 35, 35, 38, 29, 31, 43, 38,
                ],
                Lev: [
                    17, 16, 17, 35, 26, 23, 38, 36, 24, 20, 47, 8, 59, 57, 33, 34, 16, 30, 37, 27,
                    24, 33, 44, 23, 55, 46, 34,
                ],
                Num: [
                    54, 34, 51, 49, 31, 27, 89, 26, 23, 36, 35, 16, 33, 45, 41, 35, 28, 32, 22, 29,
                    35, 41, 30, 25, 19, 65, 23, 31, 39, 17, 54, 42, 56, 29, 34, 13,
                ],
                Deut: [
                    46, 37, 29, 49, 33, 25, 26, 20, 29, 22, 32, 31, 19, 29, 23, 22, 20, 22, 21, 20,
                    23, 29, 26, 22, 19, 19, 26, 69, 28, 20, 30, 52, 29, 12,
                ],
                '1Sam': [
                    28, 36, 21, 22, 12, 21, 17, 22, 27, 27, 15, 25, 23, 52, 35, 23, 58, 30, 24, 42,
                    16, 23, 28, 23, 44, 25, 12, 25, 11, 31, 13,
                ],
                '2Sam': [
                    27, 32, 39, 12, 25, 23, 29, 18, 13, 19, 27, 31, 39, 33, 37, 23, 29, 32, 44, 26,
                    22, 51, 39, 25,
                ],
                '1Kgs': [
                    53, 46, 28, 20, 32, 38, 51, 66, 28, 29, 43, 33, 34, 31, 34, 34, 24, 46, 21, 43,
                    29, 54,
                ],
                '2Kgs': [
                    18, 25, 27, 44, 27, 33, 20, 29, 37, 36, 20, 22, 25, 29, 38, 20, 41, 37, 37, 21,
                    26, 20, 37, 20, 30,
                ],
                '1Chr': [
                    54, 55, 24, 43, 41, 66, 40, 40, 44, 14, 47, 41, 14, 17, 29, 43, 27, 17, 19, 8,
                    30, 19, 32, 31, 31, 32, 34, 21, 30,
                ],
                '2Chr': [
                    18, 17, 17, 22, 14, 42, 22, 18, 31, 19, 23, 16, 23, 14, 19, 14, 19, 34, 11, 37,
                    20, 12, 21, 27, 28, 23, 9, 27, 36, 27, 21, 33, 25, 33, 27, 23,
                ],
                Neh: [11, 20, 38, 17, 19, 19, 72, 18, 37, 40, 36, 47, 31],
                Job: [
                    22, 13, 26, 21, 27, 30, 21, 22, 35, 22, 20, 25, 28, 22, 35, 22, 16, 21, 29, 29,
                    34, 30, 17, 25, 6, 14, 23, 28, 25, 31, 40, 22, 33, 37, 16, 33, 24, 41, 30, 32,
                    26, 17,
                ],
                Ps: [
                    6, 11, 9, 9, 13, 11, 18, 10, 21, 18, 7, 9, 6, 7, 5, 11, 15, 51, 15, 10, 14, 32,
                    6, 10, 22, 12, 14, 9, 11, 13, 25, 11, 22, 23, 28, 13, 40, 23, 14, 18, 14, 12, 5,
                    27, 18, 12, 10, 15, 21, 23, 21, 11, 7, 9, 24, 14, 12, 12, 18, 14, 9, 13, 12, 11,
                    14, 20, 8, 36, 37, 6, 24, 20, 28, 23, 11, 13, 21, 72, 13, 20, 17, 8, 19, 13, 14,
                    17, 7, 19, 53, 17, 16, 16, 5, 23, 11, 13, 12, 9, 9, 5, 8, 29, 22, 35, 45, 48,
                    43, 14, 31, 7, 10, 10, 9, 8, 18, 19, 2, 29, 176, 7, 8, 9, 4, 8, 5, 6, 5, 6, 8,
                ...
                Isa: [
                    31, 22, 26, 6, 30, 13, 25, 23, 20, 34, 16, 6, 22, 32, 9, 14, 14, 7, 25, 6, 17,
                    25, 18, 23, 12, 21, 13, 29, 24, 33, 9, 20, 24, 17, 10, 22, 38, 22, 8, 31, 29,
                    25, 28, 28, 25, 13, 15, 22, 26, 11, 23, 15, 12, 17, 13, 12, 21, 14, 21, 22, 11,
                    12, 19, 11, 25, 24,
                ],
                Jer: [
                    19, 37, 25, 31, 31, 30, 34, 23, 25, 25, 23, 17, 27, 22, 21, 21, 27, 23, 15, 18,
                    14, 30, 40, 10, 38, 24, 22, 17, 32, 24, 40, 44, 26, 22, 19, 32, 21, 28, 18, 16,
                    18, 22, 13, 30, 5, 28, 7, 47, 39, 46, 64, 34,
                ],
                Ezek: [
                    28, 10, 27, 17, 17, 14, 27, 18, 11, 22, 25, 28, 23, 23, 8, 63, 24, 32, 14, 44,
                    37, 31, 49, 27, 17, 21, 36, 26, 21, 26, 18, 32, 33, 31, 15, 38, 28, 23, 29, 49,
                    26, 20, 27, 31, 25, 24, 23, 35,
                ],
                ...
                Mal: [14, 17, 24],
                Acts: [
                    26, 47, 26, 37, 42, 15, 60, 40, 43, 49, 30, 25, 52, 28, 41, 40, 34, 28, 40, 38,
                    40, 30, 35, 27, 27, 32, 44, 31,
                ],
                '2Cor': [24, 17, 18, 18, 21, 18, 16, 24, 15, 18, 33, 21, 13],
                Rev: [
                ...
                Sir: [
                    30, 18, 31, 31, 15, 37, 36, 19, 18, 31, 34, 18, 26, 27, 20, 30, 32, 33, 30, 31,
                    28, 27, 27, 33, 26, 29, 30, 26, 28, 25, 31, 24, 33, 31, 26, 31, 31, 34, 35, 30,
                    22, 25, 33, 23, 26, 20, 25, 25, 16, 29, 30,
                ],
                Bar: [22, 35, 38, 37, 9, 72],
    ...
    bcv_parser.prototype.regexps.escaped_passage = RegExp(
        '(?:^|[^\\x1f\\x1e\\dA-Za-zªµºÀ-ÖØ-öø-ɏḀ-ỿⱠ-ⱿꜢ-ꞈꞋ-ꞎꞐ-ꞓꞠ-Ɦꟸ-ꟿ])((?:(?:ch(?:apters?|a?pts?\\.?|a?p?s?\\.?)?\\s*\\d+\\s*(?:[\\u2013\\u2014\\-]|through|thru|to)\\s*\\d+\\s*(?:from|of|in)(?:\\s+the\\s+book\\s+of)?\\s*)|(?:ch(?:apters?|a?pts?\\.?|a?p?s?\\.?)?\\s*\\d+\\s*(?:from|of|in)(?:\\s+the\\s+book\\s+of)?\\s*)|(?:\\d+(?:th|nd|st)\\s*ch(?:apter|a?pt\\.?|a?p?\\.?)?\\s*(?:from|of|in)(?:\\s+the\\s+book\\s+of)?\\s*))?\\x1f(\\d+)(?:/\\d+)?\\x1f(?:/\\d+\\x1f|[\\d\\s\\xa0.:,;\\x1e\\x1f&\\(\\)\\uff08\\uff09\\[\\]/"\'\\*=~\\-\\u2013\\u2014]|title(?![a-z])|see' +
            bcv_parser.prototype.regexps.space +
    ...
    bcv_parser.prototype.regexps.match_end_split =
    ...
    bcv_parser.prototype.regexps.first =
        '(?:1st|1|I|First)\\.?' + bcv_parser.prototype.regexps.space + '*';

    bcv_parser.prototype.regexps.second =
        '(?:2nd|2|II|Second)\\.?' + bcv_parser.prototype.regexps.space + '*';

    bcv_parser.prototype.regexps.third =
        '(?:3rd|3|III|Third)\\.?' + bcv_parser.prototype.regexps.space + '*';
    ...
    bcv_parser.prototype.regexps.get_books = function (include_apocrypha, case_sensitive) {
        ...
        books = [
            ...
            },
            {
                ...
                regexp: RegExp(
                    '(^|' +
                        bcv_parser.prototype.regexps.pre_book +
    ...
    (function (root) {
        ...
        function peg$parse(input, options) {
            ...
            var peg$FAILED = {},
                ...
                peg$c0 = function (val_1, val_2) {
                    val_2.unshift([val_1]);
                    return {
                        type: 'sequence',
                        value: val_2,
                        indices: [peg$savedPos, peg$currPos - 1],
                    };
                },
                peg$c1 = '(',
                ...
                peg$c23 = function (val_1, val_2, val_3, val_4) {
                    return {
                        type: 'range',
                        value: [
                            {
                ...
                peg$c26 = function (val_1, val_2, val_3) {
                    return {
                        type: 'cb_range',
                        value: [val_3, val_1, val_2],
                        indices: [peg$savedPos, peg$currPos - 1],
                    };
                },
                peg$c27 = 'th',
                                ...
                                value: [
                                    {
                                        type: 'integer',
                                        value: 151,
                                        indices: [peg$currPos - 2, peg$currPos - 1],
                                    },
                                ],
                                indices: [peg$currPos - 2, peg$currPos - 1],
                            },
                                                                                    ...
                                                                                    if (
                                                                                        ...
                                                                                        if (
                                                                                            ...
                                                                                            if (
                                                                                                ...
                                                                                                s1 =
                                                                                                    peg$parsetranslation_sequence_enclosed();
                                                                                                if (
                                                                                                    s1 ===
                                                                                                    peg$FAILED
                                                                                                ) {
                                                                                                    s1 =
                                                                                                        peg$parsetranslation_sequence();
                                                                                                    if (
                                                                                                        s1 ===
                                                                                                        peg$FAILED
                                                                                                    ) {
                                                                                                        s1 =
                                                                                                            peg$parsesequence_sep();
                                                                                                        if (
                                                                                                            s1 ===
                                                                                                            peg$FAILED
                                                                                                        ) {
                                                ...
                                                if (s4 === peg$FAILED) {
                                                    ...
                                                    if (s4 === peg$FAILED) {
                                                        ...
                                                        if (s4 === peg$FAILED) {
                                                            s4 = peg$currPos;
                                                            if (
                                                                input.charCodeAt(peg$currPos) === 97
                                                            ) {
                                                                s5 = peg$c84;
                                                                peg$currPos++;
                                                            } else {
...
const BcvParser = this.bcv_parser;

export default BcvParser;
