...
namespace Aquifer.Well.API.IntegrationTests;
...
public sealed class App : AppFixture<Program>
{
    ...
    /// This is sufficient for Well API tests and no actual web requests are sent via this fixture.
    /// </summary>
    protected override ValueTask SetupAsync()
    {
        ...
        AnonymousClient.DefaultRequestHeaders.Add("api-key", integrationTestConfiguration.Value.WellApiKey);
