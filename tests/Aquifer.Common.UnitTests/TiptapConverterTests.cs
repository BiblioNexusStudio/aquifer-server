...
public sealed class TiptapConverterTests
{
    ...
    public void TiptapConverter_ConvertJsonToHtmlItems_Success((string Json, IReadOnlyList<string> HtmlItems) data)
    {
        var convertedHtmlItems = TiptapConverter.ConvertJsonToHtmlItems(data.Json);
        Assert.Equal(data.HtmlItems, convertedHtmlItems);
    }

    [Theory]
    [MemberData(nameof(GetConversionData))]
    public void TiptapConverter_ConvertHtmlItemsToJson_Success((string Json, IReadOnlyList<string> HtmlItems) data)
    {
        var convertedJson = TiptapConverter.ConvertHtmlItemsToJson(data.HtmlItems);
        Assert.Equal(data.Json, convertedJson);
    }

    [Theory]
    [MemberData(nameof(GetConversionData))]
    public void TiptapConverter_JsonRoundtrip_Success((string Json, IReadOnlyList<string> _) data)
    {
        var convertedHtmlItems = TiptapConverter.ConvertJsonToHtmlItems(data.Json);
    ...
    [Theory]
    [MemberData(nameof(GetConversionData))]
    public void TiptapConverter_HtmlRoundtrip_Success((string _, IReadOnlyList<string> HtmlItems) data)
    {
        var convertedJson = TiptapConverter.ConvertHtmlItemsToJson(data.HtmlItems);
        var convertedHtml = TiptapConverter.ConvertJsonToHtmlItems(convertedJson);
        Assert.Equal(data.HtmlItems, convertedHtml);
    }
}