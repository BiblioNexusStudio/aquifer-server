...
public sealed class VersificationUtilitiesTests
{
    ...
    public async Task ExpandVerseIdRange_InvalidArguments_ThrowsArgumentException(
        ...
        string because)
    {
        await FluentActions.Invoking(async () => await VersificationUtilities.ExpandVerseIdRangeAsync(
                bibleId,
                startVerseId,
                endVerseId,
                _versificationService,
    ...
    [InlineData(
        ...
        1001007001,
        new[] { 1001007001 },
        "the target Bible and source Bible both map to the same multiple base verse IDs with parts")]
    [InlineData(
        1,
        2,
        1001008002,
        new[] { 1001008002, 1001008003, 1001008004 },
        "the target Bible uses multiple verses for the source Bible's single verse")]
    ...
    [InlineData(
        ...
        1002003006,
        2,
        new[] { 1002003002, 1002003003, 1002003004, 1002003005, 1002003006 },
    ...
    [InlineData(
        ...
        1001003005,
        2,
        new[] { 1001003003, 1001003004, 1001003005, 1001003005, 1001003005 },
    ...
    [InlineData(
        ...
        1001005003,
        2,
        new[] { 1001005001, 1001005002, 1001005003 },
        ...
        string because)
    {
        ...
        result
            ...
            .Should()
            .BeEquivalentTo(expectedTargetVerseIds, because);
    }
...
{
    private static readonly ReadOnlyDictionary<int, ReadOnlyDictionary<int, IReadOnlyList<string>>>
        s_baseVerseIdWithOptionalPartByBibleVerseIdMapByBibleIdMap =
            new Dictionary<int, ReadOnlyDictionary<int, IReadOnlyList<string>>>
                {
                    [1] = new Dictionary<int, IReadOnlyList<string>>
                        {
                            ...
                            [1001007001] = ["1001007001b", "1001007002a"],
                            [1001008002] = ["1001008002c", "1001008003", "1001008004a"],
                        }
                        .AsReadOnly(),
                    [2] = new Dictionary<int, IReadOnlyList<string>>
                        {
            ...
            CancellationToken cancellationToken)
    {
        return Task.FromResult(
            s_baseVerseIdWithOptionalPartByBibleVerseIdMapByBibleIdMap.GetValueOrDefault(bibleId) ??
    ...
    public Task<(int MinVerseNumber, int MaxVerseNumber)?> GetBookendVerseNumbersForChapterAsync(
        int bibleId,
        BookId bookId,
        int chapterNumber,
        CancellationToken cancellationToken)
