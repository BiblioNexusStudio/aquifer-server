...
// the following data comes from [SIL](https://iso639-3.sil.org/code_tables/download_tables)
// the TSV (.tab file) they provide was converted to SQL INSERTs
export class InsertLanguages1689091326412 implements MigrationInterface {
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`
            INSERT INTO Languages
                (ISO639_3Code, EnglishDisplay)
            VALUES
                ('aaa', 'Ghotuo'),
                ('aab', 'Alumu-Tesu'),
                ('aac', 'Ari'),
        ...
        await queryRunner.query(`
            UPDATE Languages SET IsPriority = 1 WHERE ISO639_3Code IN ('eng', 'tpi');
        `);
    }
